...
values."
  (setq-default
   ;; Base distribution to use. This is a layer containedistribution 'spacemacs
   ...
   dotspacemacs-additional-packages '(ddskk indent-guide)
