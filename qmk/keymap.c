...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Ctrl | Alt  | GUI  | EISU |Space |Adjust|Space |Space | LOWER|      |      |  Alt |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  ADJUST,  KC_SPC,  KC_SPC,  LOWER,   _______, _______, KC_RALT, _______    \
      ),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |   `  | MUTE | VOL- | VOL+ |      |      |             |      |      |      |      |   -  |  =   |
   ...
   */
  [_LOWER] = KEYMAP( \
      KC_GRAVE,KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,                   _______, _______, _______, _______, KC_MINUS, KC_EQL, \
      _______, _______, KC_UP  , _______, _______, _______,                   _______, _______, _______, _______, KC_LBRC, KC_RBRC, \
      _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______,                   _______, _______, _______, _______, _______, KC_QUOTE,\
      _______, _______, KC_MPLY, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,\
  ...
  [_ADJUST] =  KEYMAP( \
      ...
      _______, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, \
