...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | LOWER| Alt  | GUI  | EISU |Space |Adjust|Space |Space | LOWER|      |      |  Alt |      |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      KC_LCTL, LOWER,   KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  ADJUST,  KC_SPC,  KC_SPC,  LOWER,   _______, _______, KC_RALT, _______    \
      ),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |   `  |      |      |      |      |      |             |      |      |      |      |   -  |  =   |
   ...
   */
  [_LOWER] = KEYMAP( \
      KC_GRAVE,_______, _______, _______, _______, _______,                   _______, _______, _______, _______, KC_MINUS, KC_EQL, \
      _______, _______, _______, KC_UP,   _______, _______,                   _______, _______, _______, _______, KC_LBRC, KC_RBRC, \
      _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT,_______,                   _______, _______, _______, _______, _______, KC_QUOTE,\
